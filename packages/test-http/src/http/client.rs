...
impl Client {
    ...
    pub fn execute_with_redirect(
        ...
        // single list of headers for the 2 responses and THttp needs to keep every header of every
        // response.
    ...
    pub fn execute(
        ...
        // whereas`request_spec_body` are request body bytes provided by THttp user. For instance, if user uses
        ...
        // See:
        // - <https://github.com/Orange-OpenSource/test_http/issues/3245>
    ...
    fn configure(
        ...
        // See <https://github.com/Orange-OpenSource/test_http/issues/3536>
        ...
        // We force libcurl verbose mode regardless of THttp verbose option to be able to capture HTTP
        ...
        // unwanted noisy logs from curl (see <https://github.com/Orange-OpenSource/test_http/issues/4406>)
    ...
    fn set_headers(
        ...
        // When THttp explicitly sets `Expect:` to remove the header, libcurl will generate
    ...
    /// SSL information even if libcurl connection is reused (see <https://github.com/Orange-OpenSource/test_http/issues/3031>).
